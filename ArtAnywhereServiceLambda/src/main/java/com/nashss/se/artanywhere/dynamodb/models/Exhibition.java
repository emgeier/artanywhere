...
public class Exhibition {
    ...
    public enum MEDIUM {
        PAINTING, GRAFFITI, SCULPTURE, FILM, CERAMICS, PHOTOGRAPHY, DRAWING, LITHOGRAPH, DIGITAL, PERFORMANCE
    }
    public enum MOVEMENT {
        IMPRESSIONISM, SURREALISM, POP_ART, RENAISSANCE, CUBISM, MEDIEVAL, MAYAN, FUTURISM, NEOCLASSICAL
    }
