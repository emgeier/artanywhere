...
public class MetricsConstants {
    ...
    public static final String SEARCH_BY_CITY_DATE_EXHIBITION_NOT_FOUND_COUNT =
            "SearchExhibitionsByCityAndDate.ExhibitionNotFoundException.Count";
    public static final String SEARCH_BY_DATE_EXHIBITION_NOT_FOUND_COUNT =
    ...
    public static final String AIAPICALL_PUT_ITEM_ERROR_COUNT =
            "ArtInstituteDateInput.PutItemError.Count";
    public static final String SERVICE = "Service";
    public static final String SERVICE_NAME = "ArtAnywhereService";
    public static final String NAMESPACE_NAME = "U7/ArtAnywhereService";
}
