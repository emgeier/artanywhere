...
class SearchExhibitionsByMovementResultTest {

   SearchExhibitionsByMovementResult result;
        ...
        void setUp() {
            ...
            result = new SearchExhibitionsByMovementResult(exhibitionModelList);
        }
        ...
        void builder_validInput_buildsResult() {
            SearchExhibitionsByMovementResult result1 = SearchExhibitionsByMovementResult.builder()
